...
export function ShareDropdown({ title, excerpt, url }: ShareDropdownProps) {
  ...
  const shareOptions = [
    ...
    },
    {
      ...
      color: 'hover:bg-neutral-500/10',
      getUrl: () => `https://twitter.com/intent/tweet?text=${encodeURIComponent(title)}&url=${encodeURIComponent(shareUrl)}`,
    },
    {
      name: 'LinkedIn',
      icon: () => (
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-48">
        ...
        >
          ...
          <span className="ml-2">{copied ? 'Copiato!' : 'Copia link'}</span>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
